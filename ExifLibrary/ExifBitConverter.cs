...
namespace ExifLibrary
{
    ...
    public class ExifBitConverter : BitConverterEx
    {
        ...
        public static DateTime ToDateTime(byte[] data, bool hastime)
        {
            ...
            if (hastime)
            {
                if (DateTime.TryParseExact(str, "yyyy:MM:dd HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture, System.Globalization.DateTimeStyles.None, out ret))
                    return ret;
                if (DateTime.TryParseExact(str, "yyyy:M:dd HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture, System.Globalization.DateTimeStyles.None, out ret))
                    return ret;
                if (DateTime.TryParseExact(str, "yyyy: M:dd HH:mm:ss", System.Globalization.CultureInfo.InvariantCulture, System.Globalization.DateTimeStyles.None, out ret))
                    return ret;
            }
            ...
            {
                if (DateTime.TryParseExact(str, "yyyy:MM:dd", System.Globalization.CultureInfo.InvariantCulture, System.Globalization.DateTimeStyles.None, out ret))
                    return ret;
                if (DateTime.TryParseExact(str, "yyyy:M:dd", System.Globalization.CultureInfo.InvariantCulture, System.Globalization.DateTimeStyles.None, out ret))
                    return ret;
                if (DateTime.TryParseExact(str, "yyyy: M:dd", System.Globalization.CultureInfo.InvariantCulture, System.Globalization.DateTimeStyles.None, out ret))
                    return ret;
            }
